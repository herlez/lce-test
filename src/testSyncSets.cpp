...
const string files[] {"/scratch/text/dna"};
const string lceSet[] = {"../res/lceDna/i3", "../res/lceDna/i4", "../res/lceDna/i5", "../res/lceDna/i6", "../res/lceDna/i7", "../res/lceDna/i8", "../res/lceDna/i9", "../res/lceDna/i10", "../res/lceDna/i11", "../res/lceDna/i12", "../res/lceDna/i13", "../res/lceDna/i14", "../res/lceDna/i15", "../res/lceDna/i16", "../res/lceDna/iH"};
...
int main(int argc, char *argv[]) {
	...
	lceSyncSets dataSS(files[0]);
	
	const int NUMBEROFALGS = 1;
	lceDataStructure * lceData[NUMBEROFALGS] {&dataSS};
	string algo[NUMBEROFALGS] {"syncSetsLCE"};
