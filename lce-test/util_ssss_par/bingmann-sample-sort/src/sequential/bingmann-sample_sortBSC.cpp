...
void sample_sortBSC(bingmann::string* strings, size_t n, size_t depth)
{
#if 0
    ...
    {
        bingmann::string perm = strings[i];
...
void bingmann_sample_sortBSC_original(bingmann::string* strings, size_t n)
{
    sample_sortBSC<find_bkt_binsearch>(strings, n, 0);
}

void bingmann_sample_sortBSCA_original(bingmann::string* strings, size_t n)
{
