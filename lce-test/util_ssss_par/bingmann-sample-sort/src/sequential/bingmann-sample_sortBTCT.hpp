...
public:
    ...
    //! classify all strings in area by walking tree and saving bucket id
    void classify(bingmann::string* strB, bingmann::string* strE, uint16_t* bktout,
                  size_t depth)
    {
        return classify(
...
public:
    ...
    //! classify all strings in area by walking tree and saving bucket id
    void classify(bingmann::string* strB, bingmann::string* strE, uint16_t* bktout, size_t depth)
    {
        return classify(
            parallel_string_sorting::UCharStringSet(strB, strE),
            strB, strE, bktout, depth);
